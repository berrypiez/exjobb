...
class LiveTracker:
    def __init__(self,
        ...
        self.frame_rate = int(self.cap.get(cv2.CAP_PROP_FPS)) or 30

        self.newcameramtx, self.roi = cv2.getOptimalNewCameraMatrix(
            self.mtx, self.dist, 
            (self.frame_width, self.frame_height), 1, (self.frame_width, self.frame_height)
        )
        ...
        self.door_center = (self.clean_width // 2, self.frame_height)
    ...
    def start_recording(self, track_id):
        ...
        writer = cv2.VideoWriter(video_path, cv2.VideoWriter_fourcc(*"mp4v"), self.frame_rate, (self.clean_width, self.clean_height))
