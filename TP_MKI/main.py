...
from TP_MKI.old_data_processing import DataProcessing, DataSetup
...
MODELS_TO_RUN = ["knn"] #"lstm", "cnn", "linear", 
USE_REDUCED_SKELETON = True  # Toggle reduced skeleton here
...
for SCENARIO in SCENARIOS_TO_RUN:
    ...
    PROCESSED_DIR = os.path.join(BASE_PROCESSED_DIR, SCENARIO)
    os.makedirs(PROCESSED_DIR, exist_ok=True)

    # ============================================
    # STEP 1: PREPROCESS
    # ============================================
    print(f"Preprocessing data for {SCENARIO}...")
    ...
    # ============================================
    # DEBUG: inspect first feature vector
    # ============================================
    ...
    print(f"Saved processed data for {SCENARIO} — X: {X_padded.shape}, y: {y_padded.shape}")
